...
% Tabela para o calculo da rigidez da fundacao
    ...
    for t = linspace(0,(2*pi)/w,step) % Deslocamento angular do pinhao (OBS: usar step de no minimo 1e4 para evitar erros de iteracao da correcao do theta)
        ...
        % Amortecimento
            ...
            mu = 0.1211; %0.12*(Ft*Ra/(v0*vrel*rx1dsd/1000))^0.25; % Coeficiente de atrito. Valor medio de mu = 0.015 / mu máx (ponto primitivo) = 0.1211.
            ...
            Cm(i) = 2*zeta*sqrt(memod*Ktem(i)); % Coeficiente de amortecimento (kg/s)

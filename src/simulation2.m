function mm = simulation2(deltamax) % Perform the optimization using the RMS of the acceleration signal
  ...
  %% PARAMETERS OF THE CODE
    ...
    %% PLOTS
          [mm] = plots(Ampx,Ampa,RMSx,RMSa,Ampxtpm,Ampatpm,RMSxtpm,RMSatpm,Kte,deltamax,w,theta1vg,C,vrelv,thetad,thetas,R1,Kteint,KexData,KeyData,Cint,CxData,CyData,t,states,statestpm,time,acel,aceltpm,dmf,dmftpm,Tauv,Ktem,TEexp,TEmexp,step,z1,delta,ft,fttpm);
